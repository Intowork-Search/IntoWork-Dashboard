...
2. **IMPORTANT** : Copiez le token immédiatement (il ne sera plus visible)
...
- [User personal access tokens (GitLab)](https://docs.gitlab.com/ee/user/profile/personal_access_tokens.html)
- [Project access tokens (GitLab)](https://docs.gitlab.com/ee/user/project/settings/project_access_tokens.html)
