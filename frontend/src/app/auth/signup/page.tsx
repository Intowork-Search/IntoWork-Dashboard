                      ...
                      <button
                        ...
                        className={`relative p-5 rounded-2xl border-2 transition-all duration-300 group overflow-hidden ${
                          formData.role === 'employer'
                            ...
                            : 'border-base-300 bg-base-100 hover:border-blue-600/50 hover:shadow-md'
                        }`}
                      >
                        ...
                        <div className="relative z-10 text-center">
                          <div className="flex justify-center mb-3">
                            <div
                              className={`w-10 h-10 rounded-lg flex items-center justify-center transition-colors duration-300 ${
                                formData.role === 'employer'
                                  ? 'bg-blue-600 text-white'
                                  : 'bg-base-200 text-base-content/60 group-hover:bg-blue-600/20'
                              }`}
                            >
                          ...
                          <div className={`text-xs transition-colors duration-300 ${formData.role === 'employer' ? 'text-blue-600/80' : 'text-base-content/60'}`}>
