            ...
            <div className="animate-fade-in animation-delay-200">
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl border border-slate-200 p-6 sm:p-8 backdrop-blur-sm">
                ...
                <button
                  ...
                  className="w-full h-11 sm:h-12 mb-6 flex items-center justify-center gap-3 border-2 border-slate-200 rounded-lg sm:rounded-xl hover:border-slate-300 hover:bg-slate-50 transition-all duration-200 text-sm sm:text-base font-semibold text-slate-700 disabled:opacity-70 disabled:cursor-not-allowed"
                >
