    ...
    <div className={`${plusJakarta.variable} font-sans`}>
            ...
            <div className="sm:hidden pb-4 animate-fade-in">
              <div className="flex flex-col space-y-3">
                ...
                <div className="border-t border-slate-200 pt-3 flex flex-col space-y-2">
                  <Link href="/auth/signin" className="text-slate-700 hover:text-primary font-semibold transition-colors py-2 text-center">
                    Connexion
                  </Link>
      ...
      <section className="pt-24 pb-16 sm:pt-32 sm:pb-24 lg:pt-48 lg:pb-32 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center space-x-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-primary/10 mb-6 sm:mb-8 animate-fade-in">
            <span className="w-2 h-2 bg-primary rounded-full"></span>
            <span className="text-xs sm:text-sm font-semibold text-primary">IA de recrutement nouvelle génération</span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 sm:gap-8 lg:gap-16 max-w-2xl mx-auto animate-fade-in animation-delay-400">
            <div>
              <div className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-primary mb-1 sm:mb-2">10K+</div>
              <div className="text-xs sm:text-sm text-slate-600">Candidats</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-accent mb-1 sm:mb-2">500+</div>
              <div className="text-xs sm:text-sm text-slate-600">Entreprises</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-secondary mb-1 sm:mb-2">95%</div>
      ...
      <section id="how-it-works" className="py-16 sm:py-24 lg:py-32 bg-primary">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-slate-200 hover:shadow-xl transition-all duration-300">
              <div className="w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-xl sm:rounded-2xl bg-primary flex items-center justify-center mb-5 sm:mb-6 lg:mb-8">
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-slate-200 hover:shadow-xl transition-all duration-300">
              <div className="w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-xl sm:rounded-2xl bg-accent flex items-center justify-center mb-5 sm:mb-6 lg:mb-8">
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-slate-200 hover:shadow-xl transition-all duration-300">
              <div className="w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-xl sm:rounded-2xl bg-secondary flex items-center justify-center mb-5 sm:mb-6 lg:mb-8">
                <span className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white">3</span>
              </div>
      ...
      <section id="features" className="py-16 sm:py-24 lg:py-32 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-20">
            <span className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-primary/10 text-primary text-xs sm:text-sm font-semibold mb-4 sm:mb-6">
              Fonctionnalités
            </span>
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12">
            {/* Candidates */}
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border-2 border-primary/20 hover:border-primary/40 transition-all duration-300">
              <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-xl sm:rounded-2xl bg-primary flex items-center justify-center mb-5 sm:mb-6 lg:mb-8">
              ...
              <ul className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start space-x-2 sm:space-x-3">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-primary flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
            ...
            {/* Employers */}
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border-2 border-accent/20 hover:border-accent/40 transition-all duration-300">
              <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-xl sm:rounded-2xl bg-accent flex items-center justify-center mb-5 sm:mb-6 lg:mb-8">
                <svg className="w-6 h-6 sm:w-7 sm:h-7 lg:w-9 lg:h-9 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <ul className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start space-x-2 sm:space-x-3">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-accent flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-slate-700 text-sm sm:text-base lg:text-lg">{feature}</span>
                  </li>
          ...
          <div className="grid md:grid-cols-3 gap-4 sm:gap-6 mt-8 sm:mt-12">
            <div className="bg-slate-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-center">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-lg sm:rounded-xl bg-primary/20 flex items-center justify-center mx-auto mb-3 sm:mb-4">
            ...
            <div className="bg-slate-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-center">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-lg sm:rounded-xl bg-accent/20 flex items-center justify-center mx-auto mb-3 sm:mb-4">
            ...
            <div className="bg-slate-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-center">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-lg sm:rounded-xl bg-secondary/20 flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <svg className="w-6 h-6 sm:w-7 sm:h-7 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <section id="testimonials" className="py-16 sm:py-24 lg:py-32 bg-accent">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-20">
            <span className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/20 text-white text-xs sm:text-sm font-semibold mb-4 sm:mb-6">
              Témoignages
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-slate-200 hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex items-center space-x-3 sm:space-x-4">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-primary flex-shrink-0"></div>
                <div>
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-slate-200 hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex items-center space-x-3 sm:space-x-4">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-accent flex-shrink-0"></div>
                <div>
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-slate-200 hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex items-center space-x-3 sm:space-x-4">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-secondary flex-shrink-0"></div>
                <div>
